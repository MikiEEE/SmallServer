...
This guide documents the API available on the lifecycle base. Start with the
managed server path, then open the focused page for the part you are changing.

## Learn SmallServer

1. [Getting started](getting-started.md) — install, create an app, and run it.
2. [Routing](routing.md) — exact paths, methods, 404, and 405 behavior.
...
This branch supports bounded HTTP/1.1 and optional cleartext prior-knowledge
HTTP/2. TLS/ALPN and h2c upgrade remain outside the current protocol boundary.
